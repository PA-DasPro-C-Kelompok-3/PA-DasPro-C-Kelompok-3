...
JSON_REGS = f"{RUJUKAN}/data_member.json"
JSON_BRG = f"{RUJUKAN}/peralatan.json"
JSON_TRANS = f"{RUJUKAN}/riwayat_transaksi.json"
JSON_CO = f"{RUJUKAN}/keranjang.json"
JSON_BLING = f"{RUJUKAN}/riwayat_topup.json"
TXT_SK = f"{RUJUKAN}/sk_dora_foto.txt"
